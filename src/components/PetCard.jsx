...
export default function PetCard({ pet, onClick }) {
  return (
    <div
      onClick={() => onClick(pet)}
      className="flex flex-col items-center gap-2 bg-muted/40 hover:bg-muted/60 rounded-xl px-4 py-3 cursor-pointer transition-colors w-full sm:min-w-[120px] sm:flex-1"
    >
      <Avatar size="lg">
